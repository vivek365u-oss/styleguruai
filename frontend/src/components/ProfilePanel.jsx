          ...
          >
            ...
            <div className={`border rounded-[2.5rem] p-6 space-y-4 relative overflow-hidden ${isDark ? 'bg-white/5 border-white/10' : 'bg-gray-50 border-gray-200 shadow-sm'}`}>
                ...
                <div className="flex justify-between items-center mb-2">
                   ...
                   <span className={`text-[9px] font-bold px-2 py-0.5 rounded-full uppercase flex items-center gap-1 ${isDark ? 'text-yellow-400 bg-yellow-400/10' : 'text-yellow-700 bg-yellow-100'}`}>🌟 FREE UNLIMITED</span>
                </div>
                <div className={`py-8 text-center border rounded-[1.5rem] shadow-inner ${isDark ? 'bg-white/5 border-white/5' : 'bg-white border-purple-100'}`}>
                    ...
                    <p className={`text-xl font-black uppercase tracking-tight ${isDark ? 'text-white' : 'text-gray-900'}`}>Unlimited Free Access</p>
