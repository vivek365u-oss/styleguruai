...
const terms = [
  { title: 'Acceptance of Terms', body: "By accessing or using StyleGuruAI, you agree to be bound by these Terms and Conditions. Our platform provides AI-driven fashion advice, skin tone analysis, and shopping recommendations tailored for Indian complexions. If you do not agree to these terms, please discontinue use of the service." },
  { title: 'Service Accuracy & Limitation', body: "While our AI models use advanced engineering to provide high-accuracy style advice, recommendations are for informational and aesthetic purposes only. Final fashion choices, including purchases through affiliate links, are at the user's discretion. StyleGuruAI is not liable for dissatisfaction with external products or analysis variance due to lighting/photo quality." },
  { title: 'Intellectual Property', body: "The algorithms, UI design, branding, and generated content within StyleGuruAI are the exclusive property of our founders. You may use our style analysis for personal use but are prohibited from reverse-engineering or commercializing our AI recommendations without written consent." },
  ...
  { title: 'Affiliate Links', body: "StyleGuruAI earns commissions through affiliate links on Amazon, Myntra, and other retail partners. These commissions do not affect the pricing you pay, and we only recommend products we believe are relevant to your style profile." },
];

export default function TermsPage() {
  return (
    <div style={{ maxWidth: 760, margin: '0 auto', padding: '24px 24px 80px' }}>
      <SEOHead title="Terms & Conditions — StyleGuruAI" description="Read the StyleGuruAI terms of use before using the service." />
      ...
      <div style={{ padding: '20px 24px', background: C.surface, border: `1px solid ${C.border}` }}>
        <p style={{ fontSize: '12px', color: C.muted, lineHeight: '1.7', fontFamily: "'Inter',sans-serif", fontStyle: 'italic' }}>
          StyleGuruAI reserves the right to update these terms at any time. Your continued use constitutes acceptance of the latest version.
        </p>
      </div>
    </div>
  );
