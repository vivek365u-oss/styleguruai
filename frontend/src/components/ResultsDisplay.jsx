...
function ShoppingLinks({ colorName, category = "shirt", gender = "male" }) {
  ...
  const categoryConfig = {
    ...
    dress:      { amzKw: `${colorDisplay} women coord set maxi dress trending 2025`,    amzNode: '1968024031', fkCat: 'women-western-wear',      myntra: `https://www.myntra.com/co-ords?rawQuery=${colorLower}+coord+set`,           meesho: `${colorDisplay} women coord set maxi dress` },
    top:        { amzKw: `${colorDisplay} women crop top oversized tshirt trending`,    amzNode: '1968024031', fkCat: 'women-tops-tshirts',      myntra: `https://www.myntra.com/tops?rawQuery=${colorLower}+crop+top+oversized`,     meesho: `${colorDisplay} women crop top oversized` },
    kurti:      { amzKw: `${colorDisplay} women kurti with jeans casual trending`,      amzNode: '1968024031', fkCat: 'women-kurtas-and-suits',  myntra: `https://www.myntra.com/kurtas?rawQuery=${colorLower}+kurti+casual`,         meesho: `${colorDisplay} women kurti casual` },
    lehenga:    { amzKw: `${colorDisplay} women lehenga choli bridal wedding 2025`,     amzNode: '1968024031', fkCat: 'women-lehenga-cholis',    myntra: `https://www.myntra.com/lehenga-cholis?rawQuery=${colorLower}+lehenga`,      meesho: `${colorDisplay} women lehenga bridal` },
    saree:      { amzKw: `${colorDisplay} women saree georgette silk trending`,         amzNode: '1968024031', fkCat: 'women-sarees',            myntra: `https://www.myntra.com/sarees?rawQuery=${colorLower}+saree+georgette`,      meesho: `${colorDisplay} women saree georgette` },
    bottom:     { amzKw: `${colorDisplay} women baggy jeans wide leg palazzo trending`, amzNode: '1968024031', fkCat: 'women-jeans',             myntra: `https://www.myntra.com/jeans?rawQuery=${colorLower}+baggy+wide+leg`,        meesho: `${colorDisplay} women baggy jeans palazzo` },
    handbag:    { amzKw: `${colorDisplay} women sling bag tote trending 2025`,          amzNode: '1953539031', fkCat: 'women-handbags',          myntra: `https://www.myntra.com/handbags?rawQuery=${colorLower}+sling+tote`,         meesho: `${colorDisplay} women sling bag tote` },
    jewellery:  { amzKw: `${colorDisplay} women oxidised jewellery set trending`,       amzNode: '1953557031', fkCat: 'women-jewellery',         myntra: `https://www.myntra.com/jewellery?rawQuery=${colorLower}+oxidised+set`,      meesho: `${colorDisplay} women jewellery set` },
    dupatta:    { amzKw: `${colorDisplay} women dupatta stole trending`,                amzNode: '1968024031', fkCat: 'women-dupatta',           myntra: `https://www.myntra.com/dupattas?rawQuery=${colorLower}+dupatta`,            meesho: `${colorDisplay} women dupatta stole` },
    // ── GENDER AWARE ──
    watch:      { amzKw: isFemale ? `${colorDisplay} women analog watch fashion trending` : `${colorDisplay} men analog watch casual trending`, amzNode: '1350380031', fkCat: isFemale ? 'women-watches' : 'men-watches', myntra: isFemale ? `https://www.myntra.com/watches?rawQuery=${colorLower}+women+fashion` : `https://www.myntra.com/watches?rawQuery=${colorLower}+men+casual`, meesho: isFemale ? `${colorDisplay} women watch fashion` : `${colorDisplay} men watch casual` },
    wallet:     { amzKw: isFemale ? `${colorDisplay} women wallet clutch trending` : `${colorDisplay} men slim wallet rfid`, amzNode: '1953539031', fkCat: isFemale ? 'women-wallets' : 'men-wallets', myntra: isFemale ? `https://www.myntra.com/wallets?rawQuery=${colorLower}+women` : `https://www.myntra.com/wallets?rawQuery=${colorLower}+men`, meesho: isFemale ? `${colorDisplay} women wallet clutch` : `${colorDisplay} men slim wallet` },
    sunglasses: { amzKw: isFemale ? `${colorDisplay} women sunglasses trendy oversized` : `${colorDisplay} men sunglasses trendy polarized`, amzNode: '1350380031', fkCat: isFemale ? 'women-sunglasses' : 'men-sunglasses', myntra: isFemale ? `https://www.myntra.com/sunglasses?rawQuery=${colorLower}+women+trendy` : `https://www.myntra.com/sunglasses?rawQuery=${colorLower}+men+trendy`, meesho: isFemale ? `${colorDisplay} women sunglasses trendy` : `${colorDisplay} men sunglasses trendy` },
    accessories:{ amzKw: isFemale ? `${colorDisplay} women accessories jewellery trending` : `${colorDisplay} men accessories cap streetwear`, amzNode: isFemale ? '1953557031' : '1968024031', fkCat: isFemale ? 'women-jewellery' : 'men-accessories', myntra: isFemale ? `https://www.myntra.com/jewellery?rawQuery=${colorLower}` : `https://www.myntra.com/accessories?rawQuery=${colorLower}+men`, meesho: isFemale ? `${colorDisplay} women accessories` : `${colorDisplay} men accessories streetwear` },
    bag:        { amzKw: isFemale ? `${colorDisplay} women sling bag tote trending` : `${colorDisplay} men backpack sling bag streetwear`, amzNode: '1953539031', fkCat: isFemale ? 'women-handbags' : 'men-bags-backpacks', myntra: isFemale ? `https://www.myntra.com/handbags?rawQuery=${colorLower}+sling` : `https://www.myntra.com/backpacks?rawQuery=${colorLower}+men`, meesho: isFemale ? `${colorDisplay} women sling bag` : `${colorDisplay} men backpack streetwear` },
    shoes:      { amzKw: isFemale ? `${colorDisplay} women sneakers chunky platform trending` : `${colorDisplay} men sneakers casual streetwear`, amzNode: '1983518031', fkCat: isFemale ? 'women-footwear' : 'men-sports-shoes', myntra: isFemale ? `https://www.myntra.com/sneakers?rawQuery=${colorLower}+women+chunky` : `https://www.myntra.com/sneakers?rawQuery=${colorLower}+men+casual`, meesho: isFemale ? `${colorDisplay} women chunky sneakers` : `${colorDisplay} men casual sneakers` },
    footwear:   { amzKw: isFemale ? `${colorDisplay} women sneakers heels sandals trending` : `${colorDisplay} men sneakers loafers casual`, amzNode: '1983518031', fkCat: isFemale ? 'women-footwear' : 'men-sports-shoes', myntra: isFemale ? `https://www.myntra.com/sneakers?rawQuery=${colorLower}+women` : `https://www.myntra.com/sneakers?rawQuery=${colorLower}+men`, meesho: isFemale ? `${colorDisplay} women footwear trending` : `${colorDisplay} men footwear casual` },
    // ── MEN ── 2025 trending keywords
    shirt:      { amzKw: isFemale ? `${colorDisplay} women crop top coord set oversized` : `${colorDisplay} men oversized tshirt polo streetwear trending`, amzNode: '1968024031', fkCat: isFemale ? 'women-tops-tshirts' : 'men-tshirts', myntra: isFemale ? `https://www.myntra.com/tops?rawQuery=${colorLower}+crop+oversized` : `https://www.myntra.com/tshirts?rawQuery=${colorLower}+oversized+polo`, meesho: isFemale ? `${colorDisplay} women crop top coord` : `${colorDisplay} men oversized tshirt polo` },
    pant:       { amzKw: isFemale ? `${colorDisplay} women baggy jeans palazzo wide leg` : `${colorDisplay} men cargo pants joggers streetwear trending`, amzNode: '1968024031', fkCat: isFemale ? 'women-jeans' : 'men-jeans', myntra: isFemale ? `https://www.myntra.com/jeans?rawQuery=${colorLower}+baggy+wide` : `https://www.myntra.com/cargos?rawQuery=${colorLower}+cargo+joggers`, meesho: isFemale ? `${colorDisplay} women baggy jeans palazzo` : `${colorDisplay} men cargo joggers streetwear` },
