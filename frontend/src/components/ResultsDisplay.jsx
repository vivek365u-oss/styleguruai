...
function ShoppingLinks({ colorName, category = "shirt", gender = "male" }) {
  ...
  const categoryConfig = {
    ...
    dress:      { amzKw: `${colorDisplay} women coord set maxi dress trending 2025`,    amzNode: '1968024031', myntra: `https://www.myntra.com/co-ords?rawQuery=${encodeURIComponent(colorDisplay + ' coord set')}`,           meesho: `${colorDisplay} women coord set maxi dress` },
    top:        { amzKw: `${colorDisplay} women crop top oversized tshirt trending`,    amzNode: '1968024031', myntra: `https://www.myntra.com/tops?rawQuery=${encodeURIComponent(colorDisplay + ' crop top oversized')}`,     meesho: `${colorDisplay} women crop top oversized` },
    kurti:      { amzKw: `${colorDisplay} women kurti with jeans casual trending`,      amzNode: '1968024031', myntra: `https://www.myntra.com/kurtas?rawQuery=${encodeURIComponent(colorDisplay + ' kurti casual')}`,         meesho: `${colorDisplay} women kurti casual` },
    lehenga:    { amzKw: `${colorDisplay} women lehenga choli bridal wedding 2025`,     amzNode: '1968024031', myntra: `https://www.myntra.com/lehenga-cholis?rawQuery=${encodeURIComponent(colorDisplay + ' lehenga')}`,      meesho: `${colorDisplay} women lehenga bridal` },
    saree:      { amzKw: `${colorDisplay} women saree georgette silk trending`,         amzNode: '1968024031', myntra: `https://www.myntra.com/sarees?rawQuery=${encodeURIComponent(colorDisplay + ' saree georgette')}`,      meesho: `${colorDisplay} women saree georgette` },
    bottom:     { amzKw: `${colorDisplay} women baggy jeans wide leg palazzo trending`, amzNode: '1968024031', myntra: `https://www.myntra.com/jeans?rawQuery=${encodeURIComponent(colorDisplay + ' baggy wide leg')}`,        meesho: `${colorDisplay} women baggy jeans palazzo` },
    handbag:    { amzKw: `${colorDisplay} women sling bag tote trending 2025`,          amzNode: '1953539031', myntra: `https://www.myntra.com/handbags?rawQuery=${encodeURIComponent(colorDisplay + ' sling tote')}`,         meesho: `${colorDisplay} women sling bag tote` },
    jewellery:  { amzKw: `${colorDisplay} women oxidised jewellery set trending`,       amzNode: '1953557031', myntra: `https://www.myntra.com/jewellery?rawQuery=${encodeURIComponent(colorDisplay + ' oxidised set')}`,      meesho: `${colorDisplay} women jewellery set` },
    dupatta:    { amzKw: `${colorDisplay} women dupatta stole trending`,                amzNode: '1968024031', myntra: `https://www.myntra.com/dupattas?rawQuery=${encodeURIComponent(colorDisplay + ' dupatta')}`,            meesho: `${colorDisplay} women dupatta stole` },
    // ── GENDER AWARE ──
    watch:      { amzKw: isFemale ? `${colorDisplay} women analog watch fashion trending` : `${colorDisplay} men analog watch casual trending`, amzNode: '1350380031', myntra: isFemale ? `https://www.myntra.com/watches?rawQuery=${encodeURIComponent(colorDisplay + ' women fashion')}` : `https://www.myntra.com/watches?rawQuery=${encodeURIComponent(colorDisplay + ' men casual')}`, meesho: isFemale ? `${colorDisplay} women watch fashion` : `${colorDisplay} men watch casual` },
    wallet:     { amzKw: isFemale ? `${colorDisplay} women wallet clutch trending` : `${colorDisplay} men slim wallet rfid`, amzNode: '1953539031', myntra: isFemale ? `https://www.myntra.com/wallets?rawQuery=${encodeURIComponent(colorDisplay + ' women')}` : `https://www.myntra.com/wallets?rawQuery=${encodeURIComponent(colorDisplay + ' men')}`, meesho: isFemale ? `${colorDisplay} women wallet clutch` : `${colorDisplay} men slim wallet` },
    sunglasses: { amzKw: isFemale ? `${colorDisplay} women sunglasses trendy oversized` : `${colorDisplay} men sunglasses trendy polarized`, amzNode: '1350380031', myntra: isFemale ? `https://www.myntra.com/sunglasses?rawQuery=${encodeURIComponent(colorDisplay + ' women trendy')}` : `https://www.myntra.com/sunglasses?rawQuery=${encodeURIComponent(colorDisplay + ' men trendy')}`, meesho: isFemale ? `${colorDisplay} women sunglasses trendy` : `${colorDisplay} men sunglasses trendy` },
    accessories:{ amzKw: isFemale ? `${colorDisplay} women accessories jewellery trending` : `${colorDisplay} men accessories cap streetwear`, amzNode: isFemale ? '1953557031' : '1968024031', myntra: isFemale ? `https://www.myntra.com/jewellery?rawQuery=${encodeURIComponent(colorDisplay)}` : `https://www.myntra.com/accessories?rawQuery=${encodeURIComponent(colorDisplay + ' men')}`, meesho: isFemale ? `${colorDisplay} women accessories` : `${colorDisplay} men accessories streetwear` },
    bag:        { amzKw: isFemale ? `${colorDisplay} women sling bag tote trending` : `${colorDisplay} men backpack sling bag streetwear`, amzNode: '1953539031', myntra: isFemale ? `https://www.myntra.com/handbags?rawQuery=${encodeURIComponent(colorDisplay + ' sling')}` : `https://www.myntra.com/backpacks?rawQuery=${encodeURIComponent(colorDisplay + ' men')}`, meesho: isFemale ? `${colorDisplay} women sling bag` : `${colorDisplay} men backpack streetwear` },
    shoes:      { amzKw: isFemale ? `${colorDisplay} women sneakers chunky platform trending` : `${colorDisplay} men sneakers casual streetwear`, amzNode: '1983518031', myntra: isFemale ? `https://www.myntra.com/sneakers?rawQuery=${encodeURIComponent(colorDisplay + ' women chunky')}` : `https://www.myntra.com/sneakers?rawQuery=${encodeURIComponent(colorDisplay + ' men casual')}`, meesho: isFemale ? `${colorDisplay} women chunky sneakers` : `${colorDisplay} men casual sneakers` },
    footwear:   { amzKw: isFemale ? `${colorDisplay} women sneakers heels sandals trending` : `${colorDisplay} men sneakers loafers casual`, amzNode: '1983518031', myntra: isFemale ? `https://www.myntra.com/sneakers?rawQuery=${encodeURIComponent(colorDisplay + ' women')}` : `https://www.myntra.com/sneakers?rawQuery=${encodeURIComponent(colorDisplay + ' men')}`, meesho: isFemale ? `${colorDisplay} women footwear trending` : `${colorDisplay} men footwear casual` },
    // ── MEN ── 2025 trending keywords
    shirt:      { amzKw: isFemale ? `${colorDisplay} women crop top coord set oversized` : `${colorDisplay} men oversized tshirt polo streetwear trending`, amzNode: '1968024031', myntra: isFemale ? `https://www.myntra.com/tops?rawQuery=${encodeURIComponent(colorDisplay + ' crop oversized')}` : `https://www.myntra.com/tshirts?rawQuery=${encodeURIComponent(colorDisplay + ' oversized polo')}`, meesho: isFemale ? `${colorDisplay} women crop top coord` : `${colorDisplay} men oversized tshirt polo` },
    pant:       { amzKw: isFemale ? `${colorDisplay} women baggy jeans palazzo wide leg` : `${colorDisplay} men cargo pants joggers streetwear trending`, amzNode: '1968024031', myntra: isFemale ? `https://www.myntra.com/jeans?rawQuery=${encodeURIComponent(colorDisplay + ' baggy wide')}` : `https://www.myntra.com/cargos?rawQuery=${encodeURIComponent(colorDisplay + ' cargo joggers')}`, meesho: isFemale ? `${colorDisplay} women baggy jeans palazzo` : `${colorDisplay} men cargo joggers streetwear` },
    belt:       { amzKw: `${colorDisplay} men belt casual streetwear`, amzNode: '1968024031', myntra: `https://www.myntra.com/belts?rawQuery=${encodeURIComponent(colorDisplay + ' men')}`, meesho: `${colorDisplay} men belt casual` },
  };

  const cfg = categoryConfig[category] || { amzKw: `${colorDisplay} ${isFemale ? 'women' : 'men'} ${category} oversized trending 2025`, amzNode: '1968024031', myntra: `https://www.myntra.com/fashion?rawQuery=${encodeURIComponent(colorDisplay + ' ' + (isFemale ? 'women' : 'men') + ' ' + category + ' trending')}`, meesho: `${colorDisplay} ${isFemale ? 'women' : 'men'} ${category} trending` };
  ...
  const topPicksMap = {
    'navy blue': {
      shirt:   { amz: `https://www.amazon.in/s?k=navy+blue+men+oversized+tshirt&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=navy+blue+men+oversized+tshirt&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=${encodeURIComponent('navy blue men oversized')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=navy+blue+men+oversized+tshirt' },
      pant:    { amz: `https://www.amazon.in/s?k=navy+blue+men+cargo+pants&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=navy+blue+men+cargo+pants&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/cargos?rawQuery=${encodeURIComponent('navy blue cargo')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=navy+blue+men+cargo+pants' },
      dress:   { amz: `https://www.amazon.in/s?k=navy+blue+women+coord+set&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=navy+blue+women+coord+set&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/co-ords?rawQuery=${encodeURIComponent('navy blue coord set')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=navy+blue+women+coord+set' },
    },
    'teal': {
      shirt:   { amz: `https://www.amazon.in/s?k=teal+men+oversized+tshirt&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=teal+men+oversized+tshirt&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=${encodeURIComponent('teal men oversized')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=teal+men+oversized+tshirt' },
      dress:   { amz: `https://www.amazon.in/s?k=teal+women+coord+set+maxi&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=teal+women+coord+set&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/co-ords?rawQuery=${encodeURIComponent('teal coord set')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=teal+women+coord+set' },
    },
    'rust': {
      shirt:   { amz: `https://www.amazon.in/s?k=rust+orange+men+oversized+tshirt&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=rust+orange+men+oversized+tshirt&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=${encodeURIComponent('rust orange men oversized')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=rust+orange+men+tshirt' },
      dress:   { amz: `https://www.amazon.in/s?k=rust+women+coord+set+maxi&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=rust+women+coord+set&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/co-ords?rawQuery=${encodeURIComponent('rust coord set')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=rust+women+coord+set' },
    },
    'cobalt blue': {
      shirt:   { amz: `https://www.amazon.in/s?k=cobalt+blue+men+tshirt+polo&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=cobalt+blue+men+tshirt+polo&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=${encodeURIComponent('cobalt blue men polo')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=cobalt+blue+men+tshirt+polo' },
      dress:   { amz: `https://www.amazon.in/s?k=cobalt+blue+women+coord+set&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=cobalt+blue+women+coord+set&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/co-ords?rawQuery=${encodeURIComponent('cobalt blue coord set')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=cobalt+blue+women+coord+set' },
    },
    'forest green': {
      shirt:   { amz: `https://www.amazon.in/s?k=forest+green+men+oversized+tshirt&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=forest+green+men+oversized+tshirt&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=${encodeURIComponent('forest green men oversized')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=forest+green+men+oversized+tshirt' },
      kurti:   { amz: `https://www.amazon.in/s?k=forest+green+women+kurti&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=forest+green+women+kurti&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/kurtas?rawQuery=${encodeURIComponent('forest green kurti')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=forest+green+women+kurti' },
    },
    'mustard': {
      shirt:   { amz: `https://www.amazon.in/s?k=mustard+yellow+men+polo+tshirt&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=mustard+yellow+men+polo+tshirt&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=${encodeURIComponent('mustard yellow men polo')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=mustard+yellow+men+polo+tshirt' },
      dress:   { amz: `https://www.amazon.in/s?k=mustard+yellow+women+coord+set&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=mustard+yellow+women+coord+set&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/co-ords?rawQuery=${encodeURIComponent('mustard yellow coord set')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=mustard+yellow+women+coord+set' },
    },
    'burgundy': {
      shirt:   { amz: `https://www.amazon.in/s?k=burgundy+maroon+men+oversized+tshirt&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=burgundy+maroon+men+oversized+tshirt&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=${encodeURIComponent('burgundy men oversized')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=burgundy+maroon+men+tshirt' },
      lehenga: { amz: `https://www.amazon.in/s?k=burgundy+women+lehenga+choli&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=burgundy+women+lehenga+choli&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/lehenga-cholis?rawQuery=${encodeURIComponent('burgundy lehenga')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=burgundy+women+lehenga+choli' },
    },
    'coral': {
      dress:   { amz: `https://www.amazon.in/s?k=coral+women+maxi+dress+coord&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=coral+women+coord+set&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/co-ords?rawQuery=${encodeURIComponent('coral coord set')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=coral+women+coord+set+maxi' },
      shirt:   { amz: `https://www.amazon.in/s?k=coral+men+polo+tshirt&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=coral+men+polo+tshirt&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=${encodeURIComponent('coral men polo')}${myntraPriceParam}`, mee: 'https://meesho.com/search?q=coral+men+polo+tshirt' },
    },
  };
