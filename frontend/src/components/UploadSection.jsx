        ...
        {q.options.map((opt) => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 p-3 rounded-xl border-2 transition-all transform hover:scale-[1.02] ${isSelected
                  ? isDark
          ...
          <div className="flex justify-center mb-6">
            <div className={`rounded-2xl p-1.5 flex gap-1 flex-wrap border ${isDark ? 'bg-white/10 border-white/10' : 'bg-white border-purple-100 shadow-sm'}`}>
              ...
              <button
                ...
                className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm transition-all duration-300 ${mode === 'couple'
            ...
            <div className="flex justify-center mb-6">
              <div className={`rounded-2xl p-1.5 flex gap-1 border ${isDark ? 'bg-white/10 border-white/10' : 'bg-white border-purple-100 shadow-sm'}`}>
                <button
                  ...
                  className={`flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm transition-all duration-300 ${gender === 'male'
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm transition-all duration-300 ${gender === 'female'
              ...
              <div className="flex justify-center gap-3 flex-wrap">
                {seasons.map((s) => (
                  <button
                    ...
                    className={`flex flex-col items-center gap-1 px-4 py-3 rounded-2xl border font-medium text-sm transition-all duration-300 hover:scale-105 ${season === s.id
