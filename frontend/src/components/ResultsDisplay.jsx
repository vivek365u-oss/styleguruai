...
function ShoppingLinks({ colorName, category = "shirt", gender = "male" }) {
  ...
  const categoryConfig = {
    ...
    watch:      { label: 'Watch',        icon: '⌚', amzKw: isFemale ? `${colorDisplay} women analog watch fashion` : `${colorDisplay} men analog watch casual`,  amzNode: '1350380031', fkCat: isFemale ? 'women-watches' : 'men-watches',       myntra: isFemale ? `https://www.myntra.com/watches?rawQuery=${colorLower}+women` : `https://www.myntra.com/watches?rawQuery=${colorLower}+men`,             meesho: isFemale ? `${colorDisplay} women watch` : `${colorDisplay} men watch` },
    wallet:     { label: 'Wallet',       icon: '👛', amzKw: isFemale ? `${colorDisplay} women wallet clutch` : `${colorDisplay} men slim wallet`,                    amzNode: '1953539031', fkCat: isFemale ? 'women-wallets' : 'men-wallets',         myntra: isFemale ? `https://www.myntra.com/wallets?rawQuery=${colorLower}+women` : `https://www.myntra.com/wallets?rawQuery=${colorLower}+men`,           meesho: isFemale ? `${colorDisplay} women wallet` : `${colorDisplay} men wallet` },
    sunglasses: { label: 'Sunglasses',   icon: '🕶️', amzKw: isFemale ? `${colorDisplay} women sunglasses trendy` : `${colorDisplay} men sunglasses trendy`,         amzNode: '1350380031', fkCat: isFemale ? 'women-sunglasses' : 'men-sunglasses',   myntra: isFemale ? `https://www.myntra.com/sunglasses?rawQuery=${colorLower}+women+trendy` : `https://www.myntra.com/sunglasses?rawQuery=${colorLower}+men+trendy`, meesho: isFemale ? `${colorDisplay} women sunglasses` : `${colorDisplay} men sunglasses` },
    accessories:{ label: 'Accessories',  icon: '✨', amzKw: isFemale ? `${colorDisplay} women accessories jewellery` : `${colorDisplay} men accessories cap belt`,    amzNode: isFemale ? '1953557031' : '1968024031', fkCat: isFemale ? 'women-jewellery' : 'men-accessories', myntra: isFemale ? `https://www.myntra.com/jewellery?rawQuery=${colorLower}` : `https://www.myntra.com/accessories?rawQuery=${colorLower}+men`, meesho: isFemale ? `${colorDisplay} women accessories` : `${colorDisplay} men accessories` },
    bag:        { label: 'Bag',          icon: '🎒', amzKw: isFemale ? `${colorDisplay} women sling bag tote` : `${colorDisplay} men backpack sling bag`,            amzNode: '1953539031', fkCat: isFemale ? 'women-handbags' : 'men-bags-backpacks', myntra: isFemale ? `https://www.myntra.com/handbags?rawQuery=${colorLower}+sling` : `https://www.myntra.com/backpacks?rawQuery=${colorLower}+men`,       meesho: isFemale ? `${colorDisplay} women bag` : `${colorDisplay} men backpack` },
    shoes:      { label: 'Shoes',        icon: '👟', amzKw: isFemale ? `${colorDisplay} women sneakers heels` : `${colorDisplay} men sneakers casual`,               amzNode: '1983518031', fkCat: isFemale ? 'women-footwear' : 'men-sports-shoes',   myntra: isFemale ? `https://www.myntra.com/sneakers?rawQuery=${colorLower}+women` : `https://www.myntra.com/sneakers?rawQuery=${colorLower}+men`,         meesho: isFemale ? `${colorDisplay} women shoes` : `${colorDisplay} men sneakers` },
    footwear:   { label: 'Footwear',     icon: '👠', amzKw: isFemale ? `${colorDisplay} women sneakers heels sandals` : `${colorDisplay} men sneakers loafers`,      amzNode: '1983518031', fkCat: isFemale ? 'women-footwear' : 'men-sports-shoes',   myntra: isFemale ? `https://www.myntra.com/sneakers?rawQuery=${colorLower}+women` : `https://www.myntra.com/sneakers?rawQuery=${colorLower}+men`,         meesho: isFemale ? `${colorDisplay} women footwear` : `${colorDisplay} men footwear` },
