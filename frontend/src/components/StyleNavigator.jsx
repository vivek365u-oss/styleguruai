...
const TRENDING_PRODUCTS = {
  male: [
    ...
    { id:'m4', emoji:'👔', name:'Printed Shirts (half sleeve casual)',category:'Casual',     why:'Vibrant, easy aesthetic for casual outings',search:'men printed half sleeve shirt casual India' },
    ...
    { id:'m6', emoji:'✨', name:'Korean Style Outfits (simple + fitted)',category:'Casual', why:'Simple + fitted, highly trending aesthetics',search:'men korean style outfits simple fitted India' },
    ...
    { id:'m8', emoji:'🧥', name:'Layering (T-shirt + shirt/jacket)',  category:'Casual',     why:'Neutral colors + aesthetic layering',     search:'men layering t-shirt shirt jacket outfit India' },
