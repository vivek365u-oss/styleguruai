  ...
  return (
    <div className="min-h-screen bg-[#050816] text-white" style={{ fontFamily: "'Inter', 'Poppins', sans-serif" }}>
      ...
      <main className="relative z-10 max-w-3xl mx-auto px-6 py-16">
        <div className="inline-block bg-purple-900/30 border border-purple-700/40 text-purple-300 text-xs px-4 py-2 rounded-full mb-6">Get In Touch</div>
        ...
        <div className="bg-gray-900/60 border border-gray-800 rounded-2xl p-8 backdrop-blur-sm">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-500/40 rounded-xl px-6 py-4 text-purple-300 hover:text-white hover:border-purple-400 transition-all"
          >
            <span className="text-2xl">✉️</span>
            <span className="font-semibold">your-email@gmail.com</span>
          </a>
          <p className="text-gray-500 text-sm mt-6">We typically respond within 24-48 hours.</p>
        </div>
      </main>
