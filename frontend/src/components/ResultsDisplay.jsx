...
function ShoppingLinks({ colorName, category = "shirt", gender = "male" }) {
  ...
  const categoryConfig = {
    ...
    dress:      { amzKw: `${colorDisplay} women coord set maxi dress trending 2025`,    amzNode: '1968024031', myntra: `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20coord%20set`,           meesho: `${colorDisplay} women coord set maxi dress` },
    top:        { amzKw: `${colorDisplay} women crop top oversized tshirt trending`,    amzNode: '1968024031', myntra: `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20crop%20top%20oversized`,     meesho: `${colorDisplay} women crop top oversized` },
    kurti:      { amzKw: `${colorDisplay} women kurti with jeans casual trending`,      amzNode: '1968024031', myntra: `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20kurti%20casual`,         meesho: `${colorDisplay} women kurti casual` },
    lehenga:    { amzKw: `${colorDisplay} women lehenga choli bridal wedding 2025`,     amzNode: '1968024031', myntra: `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20lehenga%20choli`,      meesho: `${colorDisplay} women lehenga bridal` },
    saree:      { amzKw: `${colorDisplay} women saree georgette silk trending`,         amzNode: '1968024031', myntra: `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20saree%20georgette`,      meesho: `${colorDisplay} women saree georgette` },
    bottom:     { amzKw: `${colorDisplay} women baggy jeans wide leg palazzo trending`, amzNode: '1968024031', myntra: `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20baggy%20jeans`,        meesho: `${colorDisplay} women baggy jeans palazzo` },
    handbag:    { amzKw: `${colorDisplay} women sling bag tote trending 2025`,          amzNode: '1953539031', myntra: `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20sling%20bag`,         meesho: `${colorDisplay} women sling bag tote` },
    jewellery:  { amzKw: `${colorDisplay} women oxidised jewellery set trending`,       amzNode: '1953557031', myntra: `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20jewellery%20set`,      meesho: `${colorDisplay} women jewellery set` },
    dupatta:    { amzKw: `${colorDisplay} women dupatta stole trending`,                amzNode: '1968024031', myntra: `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20dupatta`,            meesho: `${colorDisplay} women dupatta stole` },
    // ── GENDER AWARE ──
    watch:      { amzKw: isFemale ? `${colorDisplay} women analog watch fashion trending` : `${colorDisplay} men analog watch casual trending`, amzNode: '1350380031', myntra: isFemale ? `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20watch%20fashion` : `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20men%20watch%20casual`, meesho: isFemale ? `${colorDisplay} women watch fashion` : `${colorDisplay} men watch casual` },
    wallet:     { amzKw: isFemale ? `${colorDisplay} women wallet clutch trending` : `${colorDisplay} men slim wallet rfid`, amzNode: '1953539031', myntra: isFemale ? `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20wallet` : `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20men%20wallet`, meesho: isFemale ? `${colorDisplay} women wallet clutch` : `${colorDisplay} men slim wallet` },
    sunglasses: { amzKw: isFemale ? `${colorDisplay} women sunglasses trendy oversized` : `${colorDisplay} men sunglasses trendy polarized`, amzNode: '1350380031', myntra: isFemale ? `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20sunglasses%20trendy` : `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20men%20sunglasses%20trendy`, meesho: isFemale ? `${colorDisplay} women sunglasses trendy` : `${colorDisplay} men sunglasses trendy` },
    accessories:{ amzKw: isFemale ? `${colorDisplay} women accessories jewellery trending` : `${colorDisplay} men accessories cap streetwear`, amzNode: isFemale ? '1953557031' : '1968024031', myntra: isFemale ? `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20jewellery` : `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20men%20accessories`, meesho: isFemale ? `${colorDisplay} women accessories` : `${colorDisplay} men accessories streetwear` },
    bag:        { amzKw: isFemale ? `${colorDisplay} women sling bag tote trending` : `${colorDisplay} men backpack sling bag streetwear`, amzNode: '1953539031', myntra: isFemale ? `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20sling%20bag` : `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20men%20backpack`, meesho: isFemale ? `${colorDisplay} women sling bag` : `${colorDisplay} men backpack streetwear` },
    shoes:      { amzKw: isFemale ? `${colorDisplay} women sneakers chunky platform trending` : `${colorDisplay} men sneakers casual streetwear`, amzNode: '1983518031', myntra: isFemale ? `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20sneakers%20chunky` : `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20men%20sneakers%20casual`, meesho: isFemale ? `${colorDisplay} women chunky sneakers` : `${colorDisplay} men casual sneakers` },
    footwear:   { amzKw: isFemale ? `${colorDisplay} women sneakers heels sandals trending` : `${colorDisplay} men sneakers loafers casual`, amzNode: '1983518031', myntra: isFemale ? `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20footwear` : `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20men%20footwear`, meesho: isFemale ? `${colorDisplay} women footwear trending` : `${colorDisplay} men footwear casual` },
    // ── MEN ── 2025 trending keywords
    shirt:      { amzKw: isFemale ? `${colorDisplay} women crop top coord set oversized` : `${colorDisplay} men oversized tshirt polo streetwear trending`, amzNode: '1968024031', myntra: isFemale ? `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20crop%20top%20oversized` : `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20men%20oversized%20tshirt`, meesho: isFemale ? `${colorDisplay} women crop top coord` : `${colorDisplay} men oversized tshirt polo` },
    pant:       { amzKw: isFemale ? `${colorDisplay} women baggy jeans palazzo wide leg` : `${colorDisplay} men cargo pants joggers streetwear trending`, amzNode: '1968024031', myntra: isFemale ? `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20women%20baggy%20jeans` : `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20men%20cargo%20pants`, meesho: isFemale ? `${colorDisplay} women baggy jeans palazzo` : `${colorDisplay} men cargo joggers streetwear` },
    belt:       { amzKw: `${colorDisplay} men belt casual streetwear`, amzNode: '1968024031', myntra: `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20men%20belt`, meesho: `${colorDisplay} men belt casual` },
  };

  const cfg = categoryConfig[category] || { amzKw: `${colorDisplay} ${isFemale ? 'women' : 'men'} ${category} oversized trending 2025`, amzNode: '1968024031', myntra: `https://www.myntra.com/fashion?rawQuery=${colorMyntra}%20${isFemale ? 'women' : 'men'}%20${category}%20trending`, meesho: `${colorDisplay} ${isFemale ? 'women' : 'men'} ${category} trending` };
  ...
  const topPicksMap = {
    'navy blue': {
      shirt:   { amz: `https://www.amazon.in/s?k=navy%20blue%20men%20oversized%20tshirt&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=navy%20blue%20men%20oversized%20tshirt&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=navy%20blue%20men%20oversized%20tshirt`, mee: 'https://meesho.com/search?q=navy%20blue%20men%20oversized%20tshirt' },
      pant:    { amz: `https://www.amazon.in/s?k=navy%20blue%20men%20cargo%20pants&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=navy%20blue%20men%20cargo%20pants&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=navy%20blue%20men%20cargo%20pants`, mee: 'https://meesho.com/search?q=navy%20blue%20men%20cargo%20pants' },
      dress:   { amz: `https://www.amazon.in/s?k=navy%20blue%20women%20coord%20set&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=navy%20blue%20women%20coord%20set&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=navy%20blue%20women%20coord%20set`, mee: 'https://meesho.com/search?q=navy%20blue%20women%20coord%20set' },
    },
    'teal': {
      shirt:   { amz: `https://www.amazon.in/s?k=teal%20men%20oversized%20tshirt&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=teal%20men%20oversized%20tshirt&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=teal%20men%20oversized%20tshirt`, mee: 'https://meesho.com/search?q=teal%20men%20oversized%20tshirt' },
      dress:   { amz: `https://www.amazon.in/s?k=teal%20women%20coord%20set%20maxi&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=teal%20women%20coord%20set&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=teal%20women%20coord%20set`, mee: 'https://meesho.com/search?q=teal%20women%20coord%20set' },
    },
    'rust': {
      shirt:   { amz: `https://www.amazon.in/s?k=rust%20orange%20men%20oversized%20tshirt&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=rust%20orange%20men%20oversized%20tshirt&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=rust%20orange%20men%20oversized%20tshirt`, mee: 'https://meesho.com/search?q=rust%20orange%20men%20tshirt' },
      dress:   { amz: `https://www.amazon.in/s?k=rust%20women%20coord%20set%20maxi&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=rust%20women%20coord%20set&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=rust%20women%20coord%20set`, mee: 'https://meesho.com/search?q=rust%20women%20coord%20set' },
    },
    'cobalt blue': {
      shirt:   { amz: `https://www.amazon.in/s?k=cobalt%20blue%20men%20tshirt%20polo&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=cobalt%20blue%20men%20tshirt%20polo&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=cobalt%20blue%20men%20tshirt%20polo`, mee: 'https://meesho.com/search?q=cobalt%20blue%20men%20tshirt%20polo' },
      dress:   { amz: `https://www.amazon.in/s?k=cobalt%20blue%20women%20coord%20set&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=cobalt%20blue%20women%20coord%20set&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=cobalt%20blue%20women%20coord%20set`, mee: 'https://meesho.com/search?q=cobalt%20blue%20women%20coord%20set' },
    },
    'forest green': {
      shirt:   { amz: `https://www.amazon.in/s?k=forest%20green%20men%20oversized%20tshirt&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=forest%20green%20men%20oversized%20tshirt&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=forest%20green%20men%20oversized%20tshirt`, mee: 'https://meesho.com/search?q=forest%20green%20men%20oversized%20tshirt' },
      kurti:   { amz: `https://www.amazon.in/s?k=forest%20green%20women%20kurti&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=forest%20green%20women%20kurti&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=forest%20green%20women%20kurti`, mee: 'https://meesho.com/search?q=forest%20green%20women%20kurti' },
    },
    'mustard': {
      shirt:   { amz: `https://www.amazon.in/s?k=mustard%20yellow%20men%20polo%20tshirt&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=mustard%20yellow%20men%20polo%20tshirt&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=mustard%20yellow%20men%20polo%20tshirt`, mee: 'https://meesho.com/search?q=mustard%20yellow%20men%20polo%20tshirt' },
      dress:   { amz: `https://www.amazon.in/s?k=mustard%20yellow%20women%20coord%20set&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=mustard%20yellow%20women%20coord%20set&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=mustard%20yellow%20women%20coord%20set`, mee: 'https://meesho.com/search?q=mustard%20yellow%20women%20coord%20set' },
    },
    'burgundy': {
      shirt:   { amz: `https://www.amazon.in/s?k=burgundy%20maroon%20men%20oversized%20tshirt&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=burgundy%20maroon%20men%20oversized%20tshirt&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=burgundy%20men%20oversized%20tshirt`, mee: 'https://meesho.com/search?q=burgundy%20maroon%20men%20tshirt' },
      lehenga: { amz: `https://www.amazon.in/s?k=burgundy%20women%20lehenga%20choli&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=burgundy%20women%20lehenga%20choli&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=burgundy%20women%20lehenga%20choli`, mee: 'https://meesho.com/search?q=burgundy%20women%20lehenga%20choli' },
    },
    'coral': {
      dress:   { amz: `https://www.amazon.in/s?k=coral%20women%20maxi%20dress%20coord&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=coral%20women%20coord%20set&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=coral%20women%20coord%20set`, mee: 'https://meesho.com/search?q=coral%20women%20coord%20set%20maxi' },
      shirt:   { amz: `https://www.amazon.in/s?k=coral%20men%20polo%20tshirt&rh=n%3A1968024031${amzPriceParam}&sort=featured&tag=${AMAZON_TAG}`, fk: `https://www.flipkart.com/search?q=coral%20men%20polo%20tshirt&sort=popularity_desc${fkPriceParam}`, myn: `https://www.myntra.com/tshirts?rawQuery=coral%20men%20polo%20tshirt`, mee: 'https://meesho.com/search?q=coral%20men%20polo%20tshirt' },
    },
  };
