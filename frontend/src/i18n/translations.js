export const translations = {
  en: {
    ...
    footer: "Made with StyleGuruAI • Your photos are never stored",
    analyze: "Analyze",
    ...
    perfectStyle: "Style DNA",
    styleWord: "& Palettes",
    bodyTypeTitle: "Body Type",
    eyeColorTitle: "Eye Color",
    ...
    scanFit: "Scan Fit",
    weatherStyleBriefing: "Style Intelligence Briefing",
    expertNote: "Expert Note",
    bestFabricsToday: "Best fabrics for today:",
    ...
    stats: "Stats",
    toolsHeader: "Smart Tools & Utilities",
    aiStyleBot: "AI StyleBot",
    styleBotDesc: "Chat with your AI Stylist",
    outfitChecker: "Outfit Checker",
    outfitCheckerDesc: "Rate & sync your look",
    aiCalendar: "Style Calendar",
    calendarDesc: "Plan your weekly outfits",
    wardrobeDesc: "Organize & pair your clothes",
    colorScanner: "Color Scanner",
    scannerDesc: "Scan real fabrics via camera",
    contrastChecker: "Contrast Checker",
    contrastDesc: "Check color compatibility",
    trendingNow: "Trending Hub",
    ...
    botTitle: "StyleGuruAI Bot",
    botSub: "Your AI fashion assistant",
    botPlaceholder: "Type your style question...",
    botInitial: "Welcome to your Personal Style Masterclass! 👗✨\n\nI am your ToneFit Expert Stylist. I know your Skin DNA, your Wardrobe Harmony, and the local weather.\n\nAsk me about:\n🧬 My Style DNA\n📅 How the Calendar works\n👕 My Wardrobe Score\n📷 Using the Scanner\n\nHow can I sharpen your look today?",
    ...
    botReplyGreeting: "Hey! 👋 I'm your StyleGuruAI assistant. Ask me about colors, outfits, or styling tips! What do you need help with?",
    ...
    botReplyCalendarExpert: "📅 The AI Calendar is your personal fashion scheduler! It checks your local weather and your Skin DNA to suggest 7 daily 'Drops'. This way, you always look sharp and stay comfortable, whether it's 40°C or a rainy morning in Mumbai.",
    botReplyDNAExpert: "🧬 Your Style DNA is permanent! It locks in your skin tone category and gender. Once set, the app's internal engine filters every shop link and color picker specifically for YOU. No more seeing men's shirts if your DNA is Female!",
    botReplyWardrobeExpert: "👕 Wardrobe Harmony is your styling 'Synergy' score. It measures how well the clothes you own match your ideal Power Palette. To increase it, analyze more clothes and save the ones that get a high Style Score!",
    botReplyScannerExpert: "📷 Use the Color Scanner when you're at a shop! Just point your camera at any fabric, and I'll tell you instantly if that color will make your skin glow or if it's one you should avoid.",
    botReplyCheckerExpert: "🔎 The Outfit Checker is like a final exam for your look! Upload your selfie + the dress you want to buy. Our AI simulates the color contrast on your skin to tell you if it's a 'Great Match' or 'Risky'.",
    botReplyNavigatorExpert: "🧭 The Style Navigator is your home base. It's split into:\n✨ Daily: Your look for the next hour.\n🛒 Shop: Gaps in your wardrobe.\n🧬 DNA: Your style fingerprint.",
    ...
    tapToSaveColor: "Tap to save a color",
    ...
    footerRights: "© 2025 StyleGuruAI. All rights reserved.",
    footerAffiliate: "StyleGuruAI is a participant in the Amazon Associates Programme, an affiliate advertising programme designed to provide a means for sites to earn advertising fees by advertising and linking to amazon.in.",
    navHome: "Home",
    navAbout: "About",
    ...
    test3Review: "I never knew my undertone was cool until StyleGuruAI told me. Now I understand why navy and purple always looked better on me than orange.",
    ...
    faq1Q: "What is StyleGuruAI?",
    faq1A: "StyleGuruAI is a free AI-powered fashion advisor that analyzes your skin tone from a selfie and recommends the best outfit colors, clothing combinations, and style tips personalized for you.",
    ...
    faq4Q: "Which skin tones does StyleGuruAI support?",
    faq4A: "StyleGuruAI supports all 6 major skin tone categories: Fair, Light, Medium/Wheatish, Olive/Dusky, Brown, and Dark. It works for all Indian and global skin tones.",
    faq5Q: "Is StyleGuruAI free to use?",
    faq5A: "Yes, StyleGuruAI is completely free. You can analyze your skin tone, get outfit recommendations, and shop for clothes — all at no cost.",
    faq6Q: "Can I use StyleGuruAI without uploading a photo?",
    ...
    faq7A: "Yes. StyleGuruAI provides separate recommendations for men (t-shirts, cargo pants, kurtas) and women (dresses, coord sets, kurtis, lehengas, sarees, makeup).",
    ...
    navProfile: "Profile",
    cat_other: "Other",
    tag_oversized: "Oversized",
    tag_slim: "Slim Fit",
    tag_regular: "Regular Fit",
    tag_washjeans: "Wash Jeans",
    tag_campus: "Campus Vibe",
    tag_weekend: "Weekend Outing",
    tag_office: "Office Formal",
    tag_party: "Party Wear",
    tag_traditional: "Traditional",
    tag_gym: "Gym/Active",
    lifestyle_student: "College Student",
    lifestyle_pro: "Corporate Pro",
    lifestyle_creative: "Freelancer/Creative",
    lifestyle_other: "Other",
    wearToday: "Wear This Today",
    wornSuccess: "Outfit logged for today! 🔥",
    alreadyWorn: "You already wore this today!",
    chooseVibe: "Choose Vibe & Fit",
    navNew: "← New",
    navNavigator: "Navigator",
    howItWorks: "How it works?",
    harmonyExplain: "Average score of your synced wardrobe. Save high-harmony items to increase this.",
    gapExplain: "These colors match your tone but are missing from your closet. Save them to complete the set.",
    syncMore: "Analyze & Save to Sync",
    guestName: "there",
    ...
    cat_oversized_tee: "Oversized Tee",
    ...
    trendingHub: "Elite Trending Hub",
    trendingDesc: "Curated 2025 styles for your Skin DNA",
    shopMale: "Male Collection",
    shopFemale: "Female Collection",
    buyNowCommand: "Trending 2025 Shopping",
    item_oversized_tee: "Oversized Urban Tee",
    item_baggy_jeans: "Baggy Stealth Jeans",
    item_cargo_pants: "Precision Cargoes",
    item_varsity_jacket: "Elite Varsity Jacket",
    item_minimal_sneakers: "Cloud Sneakers",
    item_cuban_collar: "Cuban Resort Shirt",
    item_corset_top: "Sculpt Corset Top",
    item_wide_leg: "Wide Leg Trousers",
    item_blazer: "Oversized Blazer",
    item_slip_dress: "Satin Slip Dress",
    item_chunky_loafers: "Platform Loafers",
    item_ribbed_knit: "Ribbed Midi Knit",
    item_saree_chiffon: "Grace Chiffon Saree",
    item_jewelry_set: "High-Shine Set",
    ...
    destroyDesc: "This will permanently erase all your Style DNA, wardrobe, and history from our servers.",
    typeDeleteToConfirm: "Type 'DELETE' to confirm destruction",
    name: "Name",
    email: "Email",
    lifestyle: "Lifestyle",
    student: "College Student",
    corpPro: "Corporate Pro",
    creativeFreelancer: "Creative Freelancer",
    socialCreator: "Social Media Creator",
    identityLock: "Identity Lock",
    physicalProfile: "Physical Profile",
    heightGroup: "Height Group",
    bodyBuild: "Body Build",
    styleArchetype: "Style Archetype",
    contrastDepth: "Contrast Depth",
    fabricPersona: "Fabric Persona",
    changePass: "Change Password",
    terms: "Terms of Use",
    addCard: "Add Card",
    communityImpact: "Community Impact",
    exportProfile: "Export Profile",
    dnaTechnical: "Technical DNA Analysis",
    dnaItaTitle: "ITA (Individual Typology Angle)",
    dnaUndertoneTitle: "Undertone Correlation",
    dnaSeasonTitle: "Color Season Master",
    dnaConfidenceTitle: "Engine Confidence Rate",
    dnaSynergyTitle: "Wardrobe Synergy Score",
    contactUs: "Contact Us",
    reportError: "Report Error",
    featureRequest: "Feature Request",
    shareApp: "Share StyleGuruAI",
    rateUs: "Rate Us",
  },
  hinglish: {
    login: "Login",
    ...
    welcomeNew: "StyleGuruAI mein swagat hai",
    ...
    welcomeGuru: "StyleGuruAI mein swagat hai!",
    ...
    botInitial: "Aapki Personal Style Masterclass mein swagat hai! 👗✨\n\nMain hoon aapka ToneFit Expert Stylist. Mujhe aapki Skin DNA, Wardrobe Harmony aur mausam, sab pata hai.\n\nMujhse poocho:\n🧬 Mera Style DNA kya hai?\n📅 Calendar kaise kaam karta hai?\n👕 Mera Wardrobe Score kya hai?\n📷 Scanner kaise use karein?\n\nAaj aapka look kaise behtar banayein?",
    ...
    botReplyGreeting: "Namaste! 👋 Main tumhara StyleGuruAI assistant hoon. Mujhse colors, outfits ya styling tips ke baare mein poocho! Main tumhari kya help kar sakta hoon?",
    ...
    botReplyCalendarExpert: "📅 AI Calendar tumhara personal fashion manager hai! Yeh tumhare city ka mausam aur tumhari Skin DNA check karke 7 din ke 'Drops' suggest karta hai. Taki Delhi ki dhoop ho ya Mumbai ki baarish, tum hamesha stylish dikho.",
    botReplyDNAExpert: "🧬 Style DNA hamesha ke liye hai! Yeh tumhara skin tone aur gender lock kar deta hai. Ek baar set hone ke baad, poora app sirf tumhare liye kaam karega. Agar DNA Female hai, toh sirf Sarees aur Kurtas hi dikhenge, kuch aur nahi!",
    botReplyWardrobeExpert: "👕 Wardrobe Harmony tumhara 'Style Score' hai. Yeh batata hai ki tumhare paas jo kapde hain wo tumhari skin pe kitne ache lagenge. Score badhane ke liye wahi kapde save karo jo AI recommend karta hai!",
    botReplyScannerExpert: "📷 Jab bhi shopping pe jao, Color Scanner use karo! Bas kisi bhi kapde pe camera point karo, aur main turant bata doonga ki wo color tumpe suit karega ya nahi.",
    botReplyCheckerExpert: "🔎 Outfit Checker tumhare look ka final test hai! Apni selfie aur naye dress ki photo upload karo. AI check karega ki wo color tumhari skin tone ke saath 'Match' ho raha hai ya 'Fail'.",
    botReplyNavigatorExpert: "🧭 Style Navigator tumhara main dashboard hai. Ismein 3 parts hain:\n✨ Daily: Aaj kya pehenna hai.\n🛒 Shop: Kya kharidna chahiye.\n🧬 DNA: Tumhari style ki identity.",
    landingHeroTitle: "Smart Fashion",
    landingHeroSub: "Advisor",
    ...
    footerRights: "© 2025 StyleGuruAI. All rights reserved.",
    footerAffiliate: "StyleGuruAI Amazon Associates Programme ka part hai, jo advertising fees earn karne ka ek zariya hai.",
    navHome: "Home",
    navAbout: "About",
    navPrivacy: "Privacy Policy",
    navContact: "Contact",
    ...
    faq1Q: "StyleGuruAI kya hai?",
    faq1A: "StyleGuruAI ek free AI-powered fashion advisor hai jo tumhari selfie analyze karke best outfit colors suggest karta hai.",
    ...
    faq4A: "StyleGuruAI saari 6 major skin tone categories ko support karta hai, specifically Indian skin tones ke liye.",
    faq5Q: "Kya yeh use karne ke liye free hai?",
    faq5A: "Haan, StyleGuruAI 100% free hai. Tum analysis aur suggestions bina kisi cost ke pa sakte ho.",
    ...
    faq7A: "Haan. StyleGuruAI Men aur Women dono ke liye alag aur perfect recommendations deta hai.",
    ...
    harmonyExplain: "Aapke wardrobe ka average score. High-harmony items save karein ise badhane ke liye.",
    gapExplain: "Ye colors aapke liye best hain par aapke closet mein nahi hain. Inhe save karke set complete karein.",
    syncMore: "Analyze karke Save karein",
    guestName: "Dost",
    ...
    dangerZone: "Danger Zone",
    blueprint: "DNA Blueprint",
    destroyAccount: "Account Destroy Karo",
    destroyDesc: "Isse aapka saara Style DNA aur history hamesha ke liye delete ho jayega.",
    typeDeleteToConfirm: "Delete confirm karne ke liye 'DELETE' type karein",
    name: "Naam",
    email: "Email",
    lifestyle: "Lifestyle",
    student: "College Student",
    ...
    contrastDepth: "Contrast Depth",
    fabricPersona: "Fabric Persona",
    changePass: "Password Badalna",
    terms: "Terms of Use",
    addCard: "Card Add Karo",
    communityImpact: "Community Impact",
    exportProfile: "Profile Export Karo",
    dnaTechnical: "Technical DNA Analysis",
    dnaItaTitle: "ITA (Individual Typology Angle)",
    dnaUndertoneTitle: "Undertone Correction",
    dnaSeasonTitle: "Color Season Master",
    dnaConfidenceTitle: "Engine Confidence Rate",
    dnaSynergyTitle: "Wardrobe Synergy Score",
    contactUs: "Contact Karo",
    reportError: "Error Report Karo",
    featureRequest: "Feature Request",
    shareApp: "Share StyleGuruAI",
    rateUs: "Rate Us",
  },
  hi: {
    ...
    discoverStyle: "अपना",
    perfectStyle: "स्टाइल डीएनए",
    styleWord: "पहचानें",
    bodyTypeTitle: "बॉडी टाइप",
    eyeColorTitle: "आँखों का रंग",
    occasionTitle: "अवसर",
    budgetTitle: "बजट",
    uploadTitle: "फ़ोटो अपलोड",
    ...
    welcomeNew: "StyleGuruAI में आपका स्वागत है ✨",
    ...
    welcomeGuru: "👋 StyleGuruAI में आपका स्वागत है!",
    ...
    weatherStyleBriefing: "स्टाइल इंटेलिजेंस ब्रीफिंग",
    expertNote: "एक्सपर्ट नोट",
    bestFabricsToday: "आज के लिए बेहतरीन फैब्रिक्स:",
    ...
    botReplyGreeting: "नमस्ते! 👋 मैं आपका StyleGuruAI सहायक हूँ। मुझसे रंगों, आउटफिट्स या स्टाइलिंग टिप्स के बारे में पूछें! मैं आपकी क्या मदद कर सकता हूँ?",
    ...
    whyToneFit: "StyleGuruAI ही क्यों?",
    ...
    footerRights: "© 2025 StyleGuruAI. सर्वाधिकार सुरक्षित।",
    footerAffiliate: "StyleGuruAI उन सहबद्ध (affiliate) कार्यक्रमों में भाग लेता है जिन्हें विज्ञापनों द्वारा आय अर्जित करने हेतु बनाया गया है।",
    navHome: "होम",
    navAbout: "अबाउट",
    ...
    test3Review: "मुझे कभी नहीं पता था कि मेरा अंडरटोन कूल है जब तक कि StyleGuruAI ने मुझे नहीं बताया। अब मैं समझती हूँ कि नेवी और पर्पल मुझ पर क्यों जचते हैं।",
    ...
    faq1Q: "StyleGuruAI क्या है?",
    faq1A: "StyleGuruAI एक मुफ़्त AI-संचालित फैशन सलाहकार है जो सेल्फी से आपकी स्किन टोन का विश्लेषण करता है और बेहतरीन रंगों और स्टाइल टिप्स की सलाह देता है।",
    ...
    faq4A: "StyleGuruAI सभी 6 प्रमुख स्किन टोन श्रेणियों का समर्थन करता है: गोरा, हल्का, मध्यम/गेहुंआ, सांवला और गहरा।",
    faq5Q: "क्या यह मुफ़्त है?",
    faq5A: "हाँ, StyleGuruAI पूरी तरह से मुफ़्त है। आप बिना किसी शुल्क के विश्लेषण कर सकते हैं और सुझाव पा सकते हैं।",
    ...
    faq7A: "हाँ। StyleGuruAI पुरुषों और महिलाओं दोनों के लिए अलग-अलग और सटीक सुझाव प्रदान करता है।",
    ...
    cat_makeup: "मेकअप",
    cat_other: "अन्य",
    tag_oversized: "ओवरसाइज्ड (Oversized)",
    tag_slim: "स्लिम फिट",
    tag_regular: "रेगुलर फिट",
    tag_washjeans: "वॉश जींस",
    tag_campus: "कैंपस वाइब",
    tag_weekend: "वीकेंड आउटिंग",
    tag_office: "ऑफिस फॉर्मल",
    tag_party: "पार्टी वियर",
    tag_traditional: "पारंपरिक (Traditional)",
    tag_gym: "जिम / एक्टिव",
    lifestyle_student: "कॉलेज स्टूडेंट",
    lifestyle_pro: "कॉर्पोरेट प्रोफेशनल",
    lifestyle_creative: "फ्रीलांसर",
    lifestyle_other: "अन्य",
    wearToday: "आज यह पहनें",
    wornSuccess: "आज के लिए आउटफिट लॉग हो गया! 🔥",
    alreadyWorn: "आप आज यह पहले ही पहन चुके हैं!",
    chooseVibe: "वाइब और फिट चुनें",
    navNavigator: "नेविगेटर",
    navTools: "टूल्स",
    navProfile: "प्रोफाइल",
    navNew: "← नया",
    howItWorks: "यह कैसे काम करता है?",
    harmonyExplain: "आपके वॉर्डरोब का औसत स्कोर। इसे बढ़ाने के लिए हाई-हारमनी आइटम सेव करें।",
    gapExplain: "ये रंग आपके लिए बेस्ट हैं लेकिन आपके क्लोसेट में नहीं हैं। सेट पूरा करने के लिए उन्हें सेव करें।",
    syncMore: "विश्लेषण और सेव करें",
    guestName: "दोस्त",
    ...
    blueprint: "DNA ब्लूप्रिंट",
    destroyAccount: "अकाउंट खत्म करें",
    destroyDesc: "यह आपके सभी स्टाइल डीएनए, वार्डरोब और इतिहास को स्थायी रूप से हटा देगा।",
    typeDeleteToConfirm: "पुष्टि के लिए 'DELETE' टाइप करें",
    name: "नाम",
    email: "ईमेल",
    lifestyle: "जीवनशैली",
    student: "कॉलेज छात्र",
    corpPro: "कॉर्पोरेट प्रोफेशनल",
    creativeFreelancer: "क्रिएटिव फ्रीलांसर",
    socialCreator: "सोशल मीडिया निर्माता",
    identityLock: "पहचान लॉक",
    physicalProfile: "शारीरिक प्रोफाइल",
    heightGroup: "कद समूह",
    bodyBuild: "शारीरिक बनावट",
    styleArchetype: "स्टाइल आर्केटाइप",
    contrastDepth: "कंट्रास्ट डेप्थ",
    fabricPersona: "फैब्रिक पर्सोना",
    changePass: "पासवर्ड बदलें",
    terms: "उपयोग की शर्तें",
    addCard: "कार्ड जोड़ें",
    communityImpact: "सामुदायिक प्रभाव",
    exportProfile: "प्रोफाइल एक्सपोर्ट करें",
    dnaTechnical: "तकनीकी DNA विश्लेषण",
    dnaItaTitle: "ITA एंगल",
    dnaUndertoneTitle: "अंडरटोन सहसंबंध",
    dnaSeasonTitle: "कलर सीजन मास्टर",
    dnaConfidenceTitle: "इंजन कॉन्फिडेंस",
    dnaSynergyTitle: "वॉर्डरोब सिनर्जी",
    contactUs: "संपर्क करें",
    reportError: "त्रुटि रिपोर्ट करें",
    featureRequest: "सुविधा का अनुरोध",
    shareApp: "स्टाइलगुरु शेयर करें",
    rateUs: "रेटिंग दें",
  },
};
