export const getLocalizedOOTD = (gender, skinTone, language, indexOffset = 0, weatherCategory = null) => {
  const OUTFITS = {
    ...
    female: {
       fair: [
         ...
         { shirt: { en: 'Lavender Maxi Dress', hinglish: 'Lavender Maxi Dress', hi: 'लैवेंडर मैक्सी ड्रेस'}, shirtHex: '#b4a7d6', pant: { en: 'Self Styled', hi: 'सेल्फ स्टाइल्ड', hinglish: 'Self Styled'}, pantHex: '', shoes: {en: 'Silver Sandals', hi: 'सिल्वर सैंडल', hinglish: 'Silver Sandals'}, occasion: {en:'Date', hi: 'डेट', hinglish:'Date'}, tip: {en:'Lavender is made for fair skin — pure elegance', hi:'लैवेंडर खासतौर पर गोरी त्वचा के लिए बना है', hinglish: 'Lavender specifically fair skin ke liye bana hai'} },
         { shirt: { en: 'Navy Blue Saree', hinglish: 'Navy Blue Saree', hi: 'नेवी ब्लू साड़ी'}, shirtHex: '#1e3a5f', pant: { en: 'Gold Border', hi: 'गोल्ड बॉर्डर', hinglish: 'Gold Border'}, pantHex: '#c5a35c', shoes: {en: 'Gold Heels', hi: 'गोल्ड हील्स', hinglish: 'Gold Heels'}, occasion: {en:'Wedding', hi: 'शादी', hinglish:'Wedding'}, tip: {en:'Navy silk with gold work is timelessly elegant', hi:'नेवी सिल्क और गोल्ड वर्क हमेशा सुंदर लगता है', hinglish: 'Navy silk aur gold work timeless elegance dete hain'} },
         { shirt: { en: 'Blush Pink Top', hinglish: 'Blush Pink Top', hi: 'ब्लश पिंक टॉप'}, shirtHex: '#ffb6c1', pant: { en: 'Light Wash Jeans', hi: 'लाइट वॉश जींस', hinglish: 'Light Wash Jeans'}, pantHex: '#a8c5dd', shoes: {en: 'White Sneakers', hi: 'सफेद स्नीकर्स', hinglish: 'White Sneakers'}, occasion: {en:'College', hi: 'कॉलेज', hinglish:'College'}, tip: {en:'Blush + light denim = casual pretty', hi:'ब्लश और लाइट डेनिम कैजुअल और सुंदर लगते हैं', hinglish: 'Blush aur light denim casual pretty look dete hain'} }
       ],
       light: [
         { shirt: { en: 'Peach Anarkali', hi: 'पीच अनारकली', hinglish: 'Peach Anarkali'}, shirtHex: '#ffdab9', pant: { en: 'Matching Leggings', hi: 'मैचिंग लेगिंग्स', hinglish: 'Matching Leggings'}, pantHex: '#ffdab9', shoes: {en: 'Tan Juttis', hi: 'टैन जुत्ती', hinglish: 'Tan Juttis'}, occasion: {en:'Festive', hi: 'त्यौहार', hinglish:'Festive'}, tip: {en:'Peach highlights the warmth in light skin', hi:'पीच हल्की त्वचा की रंगत को निखारता है', hinglish: 'Peach light skin ki warmth ko highlight karta hai'} },
         { shirt: { en: 'Sea Green Top', hi: 'सी ग्रीन टॉप', hinglish: 'Sea Green Top'}, shirtHex: '#2e8b57', pant: { en: 'White Trousers', hi: 'सफेद ट्राउजर', hinglish: 'White Trousers'}, pantHex: '#ffffff', shoes: {en: 'Beige Flats', hi: 'बेज फ्लैट्स', hinglish: 'Beige Flats'}, occasion: {en:'Office', hi: 'ऑफिस', hinglish:'Office'}, tip: {en:'Sea green + white is a fresh professional look', hi:'सी ग्रीन और सफेद एक ताज़ा प्रोफेशनल लुक है', hinglish: 'Sea green aur white fresh professional look dete hain'} },
         { shirt: { en: 'Champagne Saree', hi: 'शैंपेन साड़ी', hinglish: 'Champagne Saree'}, shirtHex: '#f7e7ce', pant: { en: 'Gold Blouse', hi: 'गोल्ड ब्लाउज', hinglish: 'Gold Blouse'}, pantHex: '#ffd700', shoes: {en: 'Rose Gold Heels', hi: 'रोज़ गोल्ड हील्स', hinglish: 'Rose Gold Heels'}, occasion: {en:'Party', hi: 'पार्टी', hinglish:'Party'}, tip: {en:'Champagne gold is perfect for light complexions', hi:'शैंपेन गोल्ड हल्की रंगत के लिए एकदम सही है', hinglish: 'Champagne gold light complexion ke liye perfect hai'} }
       ],
       medium: [
         { shirt: { en: 'Teal Anarkali', hi: 'टील अनारकली', hinglish: 'Teal Anarkali'}, shirtHex: '#008080', pant: { en: 'Gold Dupatta', hi: 'गोल्ड दुपट्टा', hinglish: 'Gold Dupatta'}, pantHex: '#c5a35c', shoes: {en: 'Gold Juttis', hi: 'गोल्ड जुत्ती', hinglish: 'Gold Juttis'}, occasion: {en:'Festive', hi: 'त्यौहार', hinglish:'Festive'}, tip: {en:'Teal + gold is a stunning festive combination', hi:'टील और गोल्ड एक शानदार त्यौहारी संयोजन है', hinglish: 'Teal + gold stunning festive combination hai'} },
         { shirt: { en: 'Royal Blue Saree', hi: 'रॉयल ब्लू साड़ी', hinglish: 'Royal Blue Saree'}, shirtHex: '#4169e1', pant: { en: 'Contrast Blouse', hi: 'कंट्रास्ट ब्लाउज', hinglish: 'Contrast Blouse'}, pantHex: '#c5a35c', shoes: {en: 'Gold Heels', hi: 'गोल्ड हील्स', hinglish: 'Gold Heels'}, occasion: {en:'Wedding', hi: 'शादी', hinglish:'Wedding'}, tip: {en:'Royal blue silk = show-stopping wedding elegance', hi:'रॉयल ब्लू सिल्क शादी के लिए सबसे सुंदर है', hinglish: 'Royal blue silk show-stopping elegance deta hai'} },
         { shirt: { en: 'Mustard Kurti', hi: 'मस्टर्ड कुर्ती', hinglish: 'Mustard Kurti'}, shirtHex: '#e8a317', pant: { en: 'White Churidar', hi: 'सफेद चूड़ीदार', hinglish: 'White Churidar'}, pantHex: '#faf0e6', shoes: {en: 'White Kolhapuri', hi: 'सफेद कोल्हापुरी', hinglish: 'White Kolhapuri'}, occasion: {en:'Office', hi: 'ऑफिस', hinglish:'Office'}, tip: {en:'Mustard on medium skin is confident and stylish', hi:'मस्टर्ड मध्यम त्वचा पर स्टाइलिश लगता है', hinglish: 'Mustard medium skin par stylish lagta hai'} }
       ],
       olive: [
         { shirt: { en: 'Wine Dress', hi: 'वाइन ड्रेस', hinglish: 'Wine Dress'}, shirtHex: '#722f37', pant: { en: 'Self Styled', hi: 'सेल्फ स्टाइल्ड', hinglish: 'Self Styled'}, pantHex: '', shoes: {en: 'Black Heels', hi: 'ब्लैक हील्स', hinglish: 'Black Heels'}, occasion: {en:'Party', hi: 'पार्टी', hinglish:'Party'}, tip: {en:'Wine shades complement olive undertones perfectly', hi:'वाइन शेड्स ऑलिव अंडरटोन पर बहुत अच्छे लगते हैं', hinglish: 'Wine shades olive undertones ko complement karte hain'} },
         { shirt: { en: 'Ivory Saree', hi: 'आइवरी साड़ी', hinglish: 'Ivory Saree'}, shirtHex: '#fffff0', pant: { en: 'Gold Border', hi: 'गोल्ड बॉर्डर', hinglish: 'Gold Border'}, pantHex: '#c5a35c', shoes: {en: 'Tan Heels', hi: 'टैन हील्स', hinglish: 'Tan Heels'}, occasion: {en:'Wedding', hi: 'शादी', hinglish:'Wedding'}, tip: {en:'Ivory on olive skin is incredibly sophisticated', hi:'ऑलिव स्किन पर आइवरी बहुत सोफिस्टिकेटेड लगता है', hinglish: 'Olive skin par ivory sophisticated lagta hai'} }
       ],
       brown: [
         { shirt: { en: 'Hot Pink Lehenga', hi: 'हॉट पिंक लहंगा', hinglish: 'Hot Pink Lehenga'}, shirtHex: '#ff69b4', pant: { en: 'Gold Dupatta', hi: 'गोल्ड दुपट्टा', hinglish: 'Gold Dupatta'}, pantHex: '#c5a35c', shoes: {en: 'Gold Heels', hi: 'गोल्ड हील्स', hinglish: 'Gold Heels'}, occasion: {en:'Wedding', hi: 'शादी', hinglish:'Wedding'}, tip: {en:'Hot pink and gold is a power combination', hi:'हॉट पिंक और गोल्ड एक पावर कॉम्बिनेशन है', hinglish: 'Hot pink aur gold power combination hai'} },
         { shirt: { en: 'Turquoise Saree', hi: 'फ़िरोज़ा साड़ी', hinglish: 'Turquoise Saree'}, shirtHex: '#40e0d0', pant: { en: 'Silver Blouse', hi: 'सिल्वर ब्लाउज', hinglish: 'Silver Blouse'}, pantHex: '#c0c0c0', shoes: {en: 'Silver Heels', hi: 'सिल्वर हील्स', hinglish: 'Silver Heels'}, occasion: {en:'Festive', hi: 'त्यौहार', hinglish:'Festive'}, tip: {en:'Turquoise makes brown skin look radiant', hi:'फ़िरोज़ा भूरी त्वचा को चमका देता है', hinglish: 'Turquoise brown skin ko radiant dikhata hai'} }
       ],
       dark: [
         { shirt: { en: 'Bright White Dress', hi: 'ब्राइट व्हाइट ड्रेस', hinglish: 'Bright White Dress'}, shirtHex: '#ffffff', pant: { en: 'Self Styled', hi: 'सेल्फ स्टाइल्ड', hinglish: 'Self Styled'}, pantHex: '', shoes: {en: 'Gold Sandals', hi: 'गोल्ड सैंडल', hinglish: 'Gold Sandals'}, occasion: {en:'Date', hi: 'डेट', hinglish:'Date'}, tip: {en:'White on dark skin = pure elegance', hi:'डार्क स्किन पर सफेद रंग बहुत सुंदर लगता है', hinglish: 'Dark skin par white pure elegance deta hai'} },
         { shirt: { en: 'Royal Purple Saree', hi: 'रॉयल पर्पल साड़ी', hinglish: 'Royal Purple Saree'}, shirtHex: '#7b2d92', pant: { en: 'Gold Blouse', hi: 'गोल्ड ब्लाउज', hinglish: 'Gold Blouse'}, pantHex: '#c5a35c', shoes: {en: 'Gold Heels', hi: 'गोल्ड हील्स', hinglish: 'Gold Heels'}, occasion: {en:'Wedding', hi: 'शादी', hinglish:'Wedding'}, tip: {en:'Purple + gold creates a royal, luxurious look', hi:'पर्पल और गोल्ड एक शाही लुक देते हैं', hinglish: 'Purple + gold royal aur luxurious look dete hain'} }
       ]
    }
  };
  ...
  const genericOutfitPoolFallback = {
    ...
    female: {
      ...
      light: [
        { shirt: 'Peach Anarkali', shirtHex: '#ffdab9', pant: 'Matching Leggings', pantHex: '#ffdab9', shoes: 'Tan Juttis', occasion: 'Festive', tip: 'Peach highlights the warmth in light skin' },
        { shirt: 'Sea Green Top', shirtHex: '#2e8b57', pant: 'White Trousers', pantHex: '#ffffff', shoes: 'Beige Flats', occasion: 'Office', tip: 'Sea green + white is a fresh professional look' },
        { shirt: 'Mint Kurti', shirtHex: '#98ff98', pant: 'White Palazzo', pantHex: '#faf0e6', shoes: 'Kolhapuri', occasion: 'Casual', tip: 'Mint green is refreshing on light skin' },
        { shirt: 'Champagne Saree', shirtHex: '#f7e7ce', pant: 'Gold Blouse', pantHex: '#ffd700', shoes: 'Rose Gold Heels', occasion: 'Party', tip: 'Champagne gold is perfect for light complexions' },
        { shirt: 'Terracotta Dress', shirtHex: '#cc5533', pant: '', pantHex: '', shoes: 'Tan Sandals', occasion: 'Brunch', tip: 'Terracotta earthy tones celebrate your light skin tone' },
      ],
      medium: [
      ...
      olive: [
        { shirt: 'Wine Dress', shirtHex: '#722f37', pant: '', pantHex: '', shoes: 'Black Heels', occasion: 'Party', tip: 'Wine shades complement olive undertones perfectly' },
        { shirt: 'Ivory Saree', shirtHex: '#fffff0', pant: 'Gold Border', pantHex: '#c5a35c', shoes: 'Tan Heels', occasion: 'Wedding', tip: 'Ivory on olive skin is incredibly sophisticated' },
        { shirt: 'Burnt Orange Silk', shirtHex: '#cc5500', pant: 'Gold Churidar', pantHex: '#c5a35c', shoes: 'Gold Sandals', occasion: 'Festive', tip: 'Burnt orange brings out the golden warmth in olive skin' },
        { shirt: 'Olive Coord Set', shirtHex: '#708238', pant: 'Matching Bottoms', pantHex: '#708238', shoes: 'Brown Heels', occasion: 'Brunch', tip: 'Tonal olive look is chic and modern' },
        { shirt: 'Burgundy Kurti', shirtHex: '#800020', pant: 'Black Leggings', pantHex: '#1a1a1a', shoes: 'Black Juttis', occasion: 'Office', tip: 'Burgundy creates a rich, professional contrast' },
      ],
      brown: [
